        ...
        <div class="row">
          <div class="col-xl-4 col-lg-12">
            <div class="zubuz-footer-textarea">
              <a href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('frontend/assets/images/logo/Kadava_logo_black.png')); ?>" alt="" width="150">
              </a>
          ...
          <div class="col-xl-2 col-md-4">
            <div class="zubuz-footer-menu">
              ...
              <ul>
                <li><a href="<?php echo e(route('user.facebook')); ?>">Facebook Ads</a></li>
                <li><a href="<?php echo e(route('user.tiktok')); ?>">Tiktok Ads</a></li>
                <li><a href="<?php echo e(route('user.pinterest')); ?>">Pinterest Ads</a></li>
              </ul>
            </div>
          </div>
          <div class="col-xl-3 col-md-4">
...
<?php /**PATH C:\laragon\www\Kadava_app\resources\views/frontend/layouts/home-footer.blade.php ENDPATH**/ ?>