...
<div class="row">
    <div class="col-lg-12">
                ...
                <div class="row mt-5"  id="pinterest_ads_container">
...
<script>
    $(document).ready(function() {
        let page = 1;
        let loading = false;
        let ENDPOINT = "<?php echo e(route('pinterest')); ?>"; // Update this with the correct route
        ...
        function loadMoreData(page) {
            ...
            .done(function(data) {
                ...
                $('#loading-gif').hide(); // Hide the loading GIF
                $("#pinterest_ads_container").append(data.html); // Append the new data
                loading = false;
            })
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Kadava_app\resources\views/pinterest.blade.php ENDPATH**/ ?>