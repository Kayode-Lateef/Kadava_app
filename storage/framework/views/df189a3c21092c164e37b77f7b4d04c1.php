      ...
      <div class="col-xl-4 col-md-6">
        <div class="zubuz-pricing-wrap">
          ...
          <form action="<?php echo e(route('pay')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="email" value="<?php echo e(auth()->check() ? auth()->user()->email : ''); ?>">
...
<?php /**PATH C:\laragon\www\Kadava_app\resources\views/frontend/layouts/pricing-contents.blade.php ENDPATH**/ ?>