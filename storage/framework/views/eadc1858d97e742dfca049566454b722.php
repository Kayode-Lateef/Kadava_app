    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo e(route('admin.createSubscription')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Kadava_app\resources\views/partials/create-subscriptionmodal.blade.php ENDPATH**/ ?>